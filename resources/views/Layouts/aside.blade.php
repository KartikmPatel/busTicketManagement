  ...
  <body>
    <div class="asi">
      <div id="aside">
        ...
        <span><i class="fab fa-playstation"></i><a href="{{url('/manageStation')}}" class="c1"> Manage Station</a></span><br><br/>
        <span><i class="fa fa-people-group"></i><a href="{{url('/manageStaff')}}" class="c1"> Manage Staff</a></span><br><br/>
