...
<div class="dashboard-card">
    <div class="card" style="width: 13rem;height: 15rem;background-color:rgb(203, 220, 184)">
    ...
    <div class="card" style="width: 13rem;height: 15rem;background-color:rgb(235, 240, 176)">
    ...
    <div class="card" style="width: 13rem;height: 15rem;background-color:rgb(183, 183, 171)">
    ...
    <div class="card" style="width: 13rem;height: 15rem;background-color:rgb(242, 205, 163)">
